...
class RoomManager {
    ...
    async startScreenShare() {
        ...
        try {
            ...
            // Show record button when screen sharing starts
            if (this.ui && this.ui.elements && this.ui.elements.recordScreenBtn) {
                this.ui.elements.recordScreenBtn.style.display = 'inline-block';
            }
    ...
    startRecording() {
        if (!this.isScreenSharing || this.isRecording) return;
    ...
    async stopScreenShare() {
        ...
        // Hide record button when screen sharing stops
        if (this.ui && this.ui.elements && this.ui.elements.recordScreenBtn) {
            this.ui.elements.recordScreenBtn.style.display = 'none';
            this.ui.elements.recordScreenBtn.textContent = '開始錄製';
            this.ui.elements.recordScreenBtn.style.color = '';
        }
