...
class RoomManager {
    ...
    async startScreenShare() {
        ...
        try {
            ...
            // Enable record button when screen sharing starts
            if (this.ui && this.ui.elements && this.ui.elements.recordScreenBtn) {
                this.ui.elements.recordScreenBtn.disabled = false;
            }
    ...
    async stopScreenShare() {
        ...
        // Disable record button when screen sharing stops
        if (this.ui && this.ui.elements && this.ui.elements.recordScreenBtn) {
            this.ui.elements.recordScreenBtn.disabled = true;
            this.ui.elements.recordScreenBtn.textContent = '開始錄製';
            this.ui.elements.recordScreenBtn.style.color = '';
        }
